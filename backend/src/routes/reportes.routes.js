...
const {
  ...
  gastosReporteQuerySchema,
  auditoriaAnulacionesQuerySchema
...
router.get(
  '/gastos',
  verificarPermiso(CAPABILITY.REPORTS_ADVANCED),
  validate({ query: gastosReporteQuerySchema }),
  asyncHandler(reportesController.gastosReporte)
);
...
router.get(
  ...
  verificarPermiso(CAPABILITY.REPORTS_ADVANCED),
  validate({ query: auditoriaAnulacionesQuerySchema }),
  asyncHandler(reportesController.auditoriaAnulaciones)
);
