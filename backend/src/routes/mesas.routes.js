...
router.post('/grupos', bloquearSiSoloLectura, esMozo, validate({ body: agruparMesasBodySchema }), asyncHandler(mesasController.agruparMesas));
router.delete('/grupos/:id', bloquearSiSoloLectura, esMozo, validate({ params: idParamSchema }), asyncHandler(mesasController.desagruparMesas));
...
router.post('/:id/pedir-cuenta', bloquearSiSoloLectura, esMozo, validate({ params: idParamSchema }), asyncHandler(mesasController.pedirCuenta));
