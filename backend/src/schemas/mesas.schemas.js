...
const estadoMesaSchema = z.enum(['LIBRE', 'OCUPADA', 'RESERVADA', 'CUENTA_PEDIDA']);
...
const agruparMesasBodySchema = z.object({
  mesaIds: z.array(positiveIntSchema).min(2, 'Se requieren al menos 2 mesas para agrupar')
}).strip();
