...
const gastosReporteQuerySchema = z.object({
  ...dateRangeRequiredFields
}).strip();

const auditoriaAnulacionesQuerySchema = z.object({
  ...dateRangeOptionalFields,
  tipo: z.enum(['CANCELACION_PEDIDO', 'ANULACION_ITEM', 'AJUSTE_STOCK', 'CAMBIO_PRECIO']).optional(),
