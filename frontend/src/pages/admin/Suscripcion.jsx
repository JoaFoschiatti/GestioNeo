...
export default function Suscripcion() {
  ...
  const precioARS = estado?.precio || suscripcion?.precioMensual || 72000
  const precioUSD = estado?.precioUSD || 60
  const cotizacion = estado?.cotizacion || null
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-text-primary font-medium">USD ${precioUSD}/mes</p>
                  <p className="text-sm text-text-tertiary">
                    ({formatCurrency(precioARS)} al cambio actual{cotizacion ? ` - $${cotizacion}` : ''})
                  </p>
                </div>
              </div>
